...
/**
 * A configuration class for the ObjectMapper. Sets custom AnnotationIntrospector and JavaTimeModul.
 * <p>
 * Derived from <a href="https://code.sbb.ch/projects/TP_TMS_IAD/repos/rti-topology-provider/browse/src/main/java/ch/sbb/tms/iad/rti/topologyprovider/common/api/JsonMapperConfiguration.java">rti-topology-provider project</a>
 */
